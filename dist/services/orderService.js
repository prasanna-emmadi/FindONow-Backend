...
function getPaginatedOrder(pageNumber, pageSize) {
    return __awaiter(this, void 0, void 0, function* () {
        const orders = yield Order_1.default.find().skip(pageNumber).limit(pageSize).exec();
        return orders;
    });
}
function getPaginatedUserOrder(userId, pageNumber, pageSize) {
    return __awaiter(this, void 0, void 0, function* () {
        const orders = yield Order_1.default.find({ userId }).skip(pageNumber).limit(pageSize).exec();
        return orders;
    });
}
function findAll() {
    return __awaiter(this, void 0, void 0, function* () {
        const orders = yield Order_1.default.find().exec();
        return orders;
    });
}
function findAllForUser(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const orders = yield Order_1.default.find({ userId }).exec();
        return orders;
    });
}
function findOne(orderId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const category = yield Order_1.default.findById(oid).exec();
        return category;
    });
}
...
function deleteOne(orderId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const deletedOrder = yield Order_1.default.deleteOne({ _id: id });
